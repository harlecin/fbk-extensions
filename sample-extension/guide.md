# Acme Slate — how to use this theme
...
**`acme/pricing-sheet`** — two to four tiers side by side, exactly one of
...
**`acme/flow`** — three to six process stages as an arrow chain, one lit via
